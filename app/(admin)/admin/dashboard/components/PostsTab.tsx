...
const PostsTab: React.FC<PostsTabProps> = ({ posts, onEdit, onDelete, onCreate }) => {
    ...
    const filteredPosts = posts.filter(post => {
        ...
        const matchesDate = !dateFilter || new Date(post.createdAt || '').toISOString().split('T')[0] === dateFilter;
