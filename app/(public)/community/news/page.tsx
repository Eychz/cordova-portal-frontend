...
const NewsPage: React.FC = () => {
    ...
    // Hook query: fetch top 20 latest news posts from backend
    ...
    const container1Posts = useMemo(() => news.slice(0, 5), [news]);
    ...
    const container2Posts = useMemo(() => news.slice(5, 10), [news]);
    ...
    const container3Posts = useMemo(() => news.slice(10, 20), [news]);
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                        ...
                                        <div className="lg:col-span-4 hidden lg:block">
                                            {loading ? (
                                                ...
                                                <div className="relative overflow-hidden border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 w-full h-[800px] cursor-pointer group" onClick={() => handleNewsClick(container1Featured[0])}>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                        ...
                                        <div className="lg:col-span-4 hidden lg:block">
                                            {loading ? (
                                                ...
                                                <div className="relative overflow-hidden border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 w-full h-[800px] cursor-pointer group" onClick={() => handleNewsClick(container2Featured[0])}>
                                                    <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors z-10" />
