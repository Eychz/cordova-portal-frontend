...
const Navbar: React.FC<NavbarProps> = ({ activePage, barangay }) => {
    ...
    return (
        <nav className={`bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'py-2' : 'py-0'
            ...
            <div className="maximize-width px-4 sm:px-6 lg:px-8">
                        ...
                        {isOpen && (
                            <div className="lg:hidden pb-4">
                                <form onSubmit={handleSearchSubmit} className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700 mb-3">
                                    ...
                                    <button
                                        type="submit"
                                        className="ml-2 bg-red-600 hover:bg-red-700 text-white p-1.5 rounded-lg transition-colors"
                                    >
                                ...
                                <Link href="/home" className={`block py-2 ${isActive('/home')
                                    ? 'text-red-600 dark:text-red-400 font-bold border-l-4 border-red-600 pl-4'
                                    : 'text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400'
                                    }`}>Home</Link>
                                <Link href="/community/news" className={`block py-2 ${isActive('/community/news')
                                    ? 'text-red-600 dark:text-red-400 font-bold border-l-4 border-red-600 pl-4'
                                    : 'text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400'
                                    }`}>News</Link>
                                <Link href="/community/events" className={`block py-2 ${isActive('/community/events')
                                    ? 'text-red-600 dark:text-red-400 font-bold border-l-4 border-red-600 pl-4'
                                    : 'text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400'
                                    }`}>Events</Link>
                                <Link href="/community/announcements" className={`block py-2 ${isActive('/community/announcements')
                                    ? 'text-red-600 dark:text-red-400 font-bold border-l-4 border-red-600 pl-4'
                                    : 'text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400'
                                    }`}>Announcements</Link>
                                ...
                                <Link href="/rescue-desk" className={`block py-2 ${isActive('/rescue-desk')
                                    ? 'text-red-600 dark:text-red-400 font-bold border-l-4 border-red-600 pl-4'
                                    : 'text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400'
                                    }`}>Rescue Desk</Link>
                                <Link
                                    href="/barangay"
                                    className={`block py-2 ${isActive('/barangay')
                                        ? 'text-red-600 dark:text-red-400 font-bold border-l-4 border-red-600 pl-4'
                                        : 'text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400'
                                        }`}
