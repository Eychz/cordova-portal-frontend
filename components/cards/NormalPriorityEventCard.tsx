...
const NormalPriorityEventCard: React.FC<NormalPriorityEventCardProps> = ({
    ...
    return (
        <div
            onClick={onClick}
            className="group cursor-pointer min-w-0 h-full"
        >
            <div className="relative bg-white dark:bg-gray-800 rounded-none overflow-hidden border border-gray-200 dark:border-gray-700 premium-flag-card h-full flex flex-col justify-between">
                ...
                <div>
                    ...
                    <div className="p-5 relative">
                        ...
                        <p className="text-gray-750 dark:text-gray-200 text-sm line-clamp-3">
                            {description}
                        </p>
                    </div>
                </div>
                <div className="p-5 pt-0 relative">
                    <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-300 border-t border-gray-100 dark:border-gray-700 pt-4">
